    ...
    return (
        <header className="app-header">
            ...
            <nav className="app-nav">
                ...
                <a id={ROUTER.synchronizer} className="app-tab" title={lang.header.synchronizer} href={prependHash(ROUTER.synchronizer)}>
                    <SynchronizerSVG />
                </a>
                <a id={ROUTER.gist} className="app-tab" title={lang.header.gist} href={prependHash(ROUTER.gist)}>
                    <CloudSVG />
                </a>
                <a id={ROUTER.preferences} className="app-tab" title={lang.header.preferences} href={prependHash(ROUTER.preferences)}>
                    <PreferencesSVG />
                </a>
            </nav>
        </header>
